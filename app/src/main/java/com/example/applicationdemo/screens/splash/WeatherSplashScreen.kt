package com.example.applicationdemo.screens.splash
...
import com.example.applicationdemo.navigation.WeatherScreens
    ...
    Surface(modifier = Modifier
        ...
        Column(modifier= Modifier.padding(1.dp),
          ...
          Image(painter = painterResource(id = R.drawable.sun), contentDescription = "sunny icon",
            ...
            Text(text = "Find the Sun?", style = MaterialTheme.typography.bodyLarge,
